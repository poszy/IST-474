...
select * from employees where HIRE_DATE > '01-jan-02' and HIRE_DATE < '01-jan-05';
...
select 
       ...
       TT (employee >< department) firstname || lastname 
...
select distrinct(COUNTRY_ID) from locations order by COUNTRY_ID;
